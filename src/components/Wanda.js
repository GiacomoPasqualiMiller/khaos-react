...
/* //Dark mode
      if (
        ...
        window.onload = function () {
          imgWanda.classList.add("zoomWanda");
...
const Wanda = () => {
  ...
  //IRON MAN EFFECT
  const [wandaFly, setWandaFly] = useState(false);
  const handleFly = () => {
    setWandaFly(true);
  };
  return (
      ...
      <html lang="en" className="dark">
        ...
        <body className="h-screen dark:bg-black">
          ...
          <div
            id="popup-modal"
            tabIndex="-1"
            className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full justify-center items-center flex h-full  bg-gradient-to-l from-[#ae1a28] via-[#d01111] to-[#15070e]"
            aria-modal="true"
            role="dialog"
          >
            <div className="relative p-0 w-full max-w-md h-full my-auto">
              <div className="relative h-full bg-white bg-transparent">
                <div className="p-6 text-center">
                  ...
                  <img
                    id="wanda"
                    src={require("../images/card-wanda.png")}
                    alt=""
                    className="h-[400px] mt-20 mx-auto transition-all duration-1000 scroll-none"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="flex w-full justify-center">
            ...
            <section className="w-1/3 flex justify-center flex-wrap mt-6">
              ...
              <div className="flex flex-col justify-center items-center w-full space-y-6 p-1 px-4 rounded-xl bg- mb-4">
                <div className="flex flex-col justify-center items-center w-full space-y-6 bg-red-700 rounded-lg">
                  <p className="text-center text-white">Clicca la carta!</p>
                </div>
              </div>
              {/* <!-- Image Container --> */}
              <div className="flex flex-col justify-center items-center w-full space-y-6 p-1 rounded-xl bg-red-700">
                <div className="flex flex-col justify-center items-center w-full space-y-6 rounded-xl">
                  <img
                    src={require("../images/wanda.jpg")}
                    alt=""
                    height="500"
