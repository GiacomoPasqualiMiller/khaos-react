...
/* //Dark mode
      ...
      const imgZooming = function () {
        imgCap.classList.add("zoomCapitanMarvel");
      ...
      <html lang="en" className="dark">
        ...
        <body className="h-screen dark:bg-black">
          ...
          <div
            ...
            tabIndex="-1"
            className="hidden 
            overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full justify-center items-center flex h-full bg-gradient-to-l from-[#CC4224]  via-[#F3D403] to-[#2A75B3]"
            aria-modal="true"
            role="dialog"
          >
            <div className="relative p-0 w-full max-w-md h-full my-auto">
              <div className="relative h-full bg-white bg-transparent">
                <div className="p-6 text-center h-full">
                  ...
                  <img
                    id="capitan-marvel"
                    src={require("../images/card-Captain-Marvel.png")}
                    alt=""
          ...
          <div className="flex w-full justify-center">
            ...
            <section className="w-1/3 flex justify-center flex-wrap mt-6">
              ...
              <div className="flex flex-col justify-center items-center w-full space-y-6 p-1 px-4 rounded-xl bg- mb-4">
                <div className="flex flex-col justify-center items-center w-full space-y-6 bg-blue-600 rounded-lg">
                  <p className="text-center text-white">Clicca la carta!</p>
                </div>
              </div>

              {/* <!-- Image Container --> */}
              <div className="flex flex-col justify-center items-center w-full space-y-6 p-1 rounded-xl bg-blue-600">
                <div className="flex flex-col justify-center items-center w-full space-y-6 rounded-xl">
                  <img
                    src={require("../images/capitan-marvel.jpg")}
                    alt=""
                    height="500"
