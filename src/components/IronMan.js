...
const IronMan = () => {
  ...
  const DarkMode = () => {
    ...
    window.onload = function () {
      imgIronMan.classList.add("zoomIronMan");
      ...
      <html lang="en" className="dark">
        ...
        <body className="h-screen dark:bg-black">
          ...
          <div
            id="popup-modal"
            tabindex="-1"
            className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full justify-center items-center flex h-full bg-gradient-to-l from-[#4b0908] via-[#aa0505] to-[#fbca03]"
            aria-modal="true"
            role="dialog"
          >
          ...
          <div className="flex w-full justify-center">
            ...
            <section className="w-1/3 flex justify-center flex-wrap mt-6">
              ...
              <div className="flex flex-col justify-center items-center w-full space-y-6 p-1 px-4 rounded-xl bg- mb-4">
                <div className="flex flex-col justify-center items-center w-full space-y-6 bg-yellow-600 rounded-lg">
                  <p className="text-center text-white">Clicca la carta!</p>
                </div>
              </div>
              {/* <!-- Image Container --> */}
              <div className="flex flex-col justify-center items-center w-full space-y-6 p-1 rounded-xl bg-yellow-600">
